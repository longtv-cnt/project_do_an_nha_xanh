...
class baocaoController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.layouts.baocao', compact('tintuctheoloai1','khachloaikhach1','spduan1','sploaisp1','phieuthu_count','phieuthuprice','khachhang_count','sanpham_count','price','max','sanpham_bdsmax','min','sanpham_bdsmin'));
    }
