        ...
        <div class="content-wrapper">
            ...
            <div class="card">
                ...
                <form action='{{ route('user.update', ['id' => $user->id]) }}' method="POST">
                    ...
                    <div class="form-group ">
                        <select name="roles[]" multiple class="form-control" id="roles">
                            ...
                            @foreach ($roles as $role)
                                <option value="{{ $role->id }}" {{ $roleids->contains($role->id) ? 'selected' : '' }}>
                    ...
                    <div class="form-group">
                        <input type="date" class="form-control" value="<?php echo strftime('%Y-%m-%d', strtotime($user['ngaysinh'])); ?>" name="date_of_birth" />
                    </div>
