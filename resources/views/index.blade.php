                                            ...
                                            <div class="wpb_wrapper">
                                                ...
                                                <span style="font-size: 12pt; color: #0000ff;">
                                                    <strong>
                                                        ...
                                                        @endif
                                                        @if($product->daban==1)
                                                            <p style="text-align: center;"><span style="font-size: 12pt; color: red;"><strong>Đã bán</strong></span></p>
                                                        @else
                                                            <p style="text-align: center;"><span style="font-size: 12pt; color: #ffffff;"><strong>Chưa bán</strong></span></p>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
