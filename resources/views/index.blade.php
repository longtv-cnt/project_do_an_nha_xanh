                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="duan" id="duan" class="sorting">
                                                        ...
                                                        @foreach ($duans as $duan)
                                                            <option value="{{ $duan->ma_du_an }}">{{ $duan->tenduan }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <h1 style=" margin-top: 28px; margin-left: 5px;">
                                                    <button type="submit" class="btn btn-primary btn-sm"
                                                        style=" height: 50px; width: 120px; background-color:greenyellow; border-style: none; ">
                                                        <h2 style=" color: white; align-content: center">Search</h2>
                                                    </button>
                                                </h1>
                                            </div>
                                        </td>
                            ...
                            <div class="range_item">
                                <div id="slider-range"
                                    ...
                                    <div class="ui-slider-range ui-corner-all ui-widget-header"
                                        style="left: 58.6%; width: 41.4%;"></div>
                                    <span tabindex="0" class="ui-slider-handle ui-corner-all ui-state-default"
                                        style="left: 58.6%;"></span>
                                    <span tabindex="0" class="ui-slider-handle ui-corner-all ui-state-default"
                                        style="left: 100%;"></span>
                                </div>
                                <div class="">
                    ...
                    <aside class="left_widgets p_filter_widgets">
                        <div class="l_w_title">
                            <h3 style=" margin-top: 28px; margin-left: 5px;">Filter
                                <button type="submit" class="btn btn-primary btn-sm"
                                    style=" height: 25px; width: 80px; background-color:greenyellow; border-style: none; ">
                                    <h4 style=" color: white; align-content: center">Search</h4>
                                </button>
                            </h3>
                        </div>
                        <div class="widgets_inner">
