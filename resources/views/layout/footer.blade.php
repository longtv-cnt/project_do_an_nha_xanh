    ...
    <div class="wf-wrap">
        <div class="wf-container-footer">
            <div class="wf-container">
                ...
                <section id="black-studio-tinymce-6" class="widget widget_black_studio_tinymce wf-cell wf-1-4"><div class="textwidget"><p><a href="https://aquacityvn.vn/"><img loading="lazy" class="wp-image-2751 size-full alignnone lazyloaded" src="uploads/product/logo1.png" data-src="uploads/product/logo1.png" alt="Logo Aqua City" width="200" height="51"></a><br>
                            <i class="fa icon-location-2"></i> Long Hưng, Biên Hòa, Đồng Nai</p>
                        <p><i class="fa icon-phone"></i> <strong style="text-decoration: none;"><a style="text-decoration: none;" href="tel:+84909811223">0909 811 223</a></strong> - <strong style="text-decoration: none;"><a style="text-decoration: none;" href="tel:+84908551686">0908 551 686</a></strong></p>
                        <p><i class="fa icon-globe-3"></i> <a style="text-decoration: none;" href="https://aquacityvn.vn/" target="_blank" rel="noopener">https://aquacityvn.vn/</a></p>
                        <p><i class="fa icon-mail-4"></i> info@aquacityvn.vn</p>
                        <p><a href="//www.dmca.com/Protection/Status.aspx?ID=52a05949-bf02-4174-ac2d-4fc0e2c3b3e2" title="DMCA.com Protection Status" class="dmca-badge"> <img loading="lazy" class=" ls-is-cached lazyloaded" src="https://images.dmca.com/Badges/_dmca_premi_badge_5.png?ID=52a05949-bf02-4174-ac2d-4fc0e2c3b3e2" alt="DMCA.com Protection Status"></a>  </p>
                    </div></section><section id="presscore-contact-form-widget-2" class="widget widget_presscore-contact-form-widget wf-cell wf-1-4"><div class="widget-title">NHẬN BẢNG GIÁ MỚI NHẤT</div><form class="contact-form dt-form" action="/" method="post">
...
</span></div><span class="form-message"><label class="assistive-text">Message</label><textarea placeholder="Message" name="message" rows="1" aria-required="false"></textarea>
                ...
                </section><section id="black-studio-tinymce-10" class="widget widget_black_studio_tinymce wf-cell wf-1-4"><div class="widget-title">CÁC DỰ ÁN</div><div class="textwidget"><p><a style="text-decoration: none;" href="https://aquacityvn.vn/vi-tri-aqua-city/">Vị trí</a></p>
                        @foreach($duans as $duan)
                            <p><a style="text-decoration: none;" href="https://aquacityvn.vn/cac-phan-khu-aqua-city/">{{$duan->tenduan}}</a></p>
                        @endforeach
                    </div></section><section id="black-studio-tinymce-11" class="widget widget_black_studio_tinymce wf-cell wf-1-4"><div class="widget-title">GIỚI THIỆU</div><div class="textwidget"><p><a style="text-decoration: none;" href="https://aquacityvn.vn/dao-phuong-hoang/" data-schema-attribute="">Đảo Phượng Hoàng</a></p>
