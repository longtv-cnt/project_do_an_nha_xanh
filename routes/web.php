...
Route::get('/duan/create', [du_anController::class,'create'])->name('duan.create');
...
Route::get('/duan/edit/{maduan}', [du_anController::class,'edit'])->name('duan.edit');
...
Route::DELETE('/loaisp_bds/destroy/{maloai}', [loaisp_bdsController::class,'destroy']);
Route::get('/loaisp_bds/edit/{maloai}', [loaisp_bdsController::class,'edit'])->name('loaisp_bds.edit');
Route::PATCH('/loaisp_bds/update/{maloai}', [loaisp_bdsController::class,'update']);
